...
Visibility.onVisible(function(){
    ...
    setTimeout(function(){
        $(".animar_fade_in_down").addClass("animated fadeInDown");
    },1600);
    setTimeout(function(){
        $(".animar_fade_in_down_interna").addClass("animated fadeInDown");
    },1200);
});
...
$('.formphp').on('submit', function() {
	var emailContato = "pedrooberto@hotmail.com"; // Escreva aqui o seu e-mail
